...
public class JwtUtil
{
    ...
    // 加密密文，私钥
    public static final String JWT_SECRET = "website_csrf_filter12111111111111111111111111111111111";
...
//	public static final long EXPIRE_TIME = 7 * 24 * 3600 * 1000; // 一个星期
    ...
    {
        // 本地的密码解码
        byte[] encodedKey = Base64.getEncoder().encode(JWT_SECRET.getBytes(StandardCharsets.UTF_8));
